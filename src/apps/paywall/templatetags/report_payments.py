...
#
#
# class SalesByPlanReportView(View):
#     def get(self, request, *args, **kwargs):
#         template = loader.get_template('admin/report/sales_report_payments.html')
#         context = {
#             'form': RangeDateForm,
#             'sites': ''
#         }
...
#             end_month = 'febrero'
#
#             # total_subscriptions = self.get_queryset_base(start_date, end_date, range)
#             total_payments = self.get_payment_base(year_start, year_end, start_month, end_month)
#             total_bajas = self.get_bajas_base(start_date, end_date, range)
#             # total_payment = self.get_payment_base(start_date, end_date, range)
#
...
#         return queryset
#
#     def get_payment_base(self, year_start, year_end, start_month, end_month):
#         payment = Payment.objects.filter(
#             # date_payment__year__gte=year,
#             # date_payment__year__lte=year,
#             # date_payment__month__gte=month,
#             # date_payment__month__lte=month
#
